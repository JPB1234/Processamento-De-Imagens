...
from filters import low_pass, high_pass, low_pass_implemented, high_pass_implemented, teste_high_pass_dinamic_kernel
...
def high_pass_slider(root, img_cv, canvas):
    def on_slider_change(value):
        ...
        teste_high_pass_dinamic_kernel(img_cv, canvas, kernel_value)
...
filters_menu.add_command(label="High Pass Filter with Slider", command=lambda: high_pass_slider(root, img_cv, edited_image_canvas))
